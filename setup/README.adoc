...
IMPORTANT: This is not part of the demo/workshop. It is internal tooling for Red Hatters to spin up the infrastructure before running the walkthrough published at the link:https://redhat-scholars.github.io/multi-cluster-app-distribution-demo[course site].
...
. Imports Cluster A and Cluster B into ACM as managed clusters
