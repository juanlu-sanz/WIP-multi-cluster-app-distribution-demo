...
| IPsec tunnel connects Azure VNet and AWS VPC at the pod/service CIDR level
...
| Submariner automatically opens the required NSG rules (Azure) and security group rules (AWS)
