...
oc apply -f 00-current-state/configmap.yaml --context cluster-a
...
oc apply -f 00-current-state/configmap.yaml --context cluster-b
...
oc delete -f 00-current-state/configmap.yaml --context cluster-a
